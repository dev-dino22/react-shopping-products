...
function Flex({ className, children, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$9, { className, ...props, children });
}
...
function MobileLayout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container$8, { children }) });
}
...
`;
const ShopErrorContext = reactExports.createContext(null);
function ShopErrorProvider({ children }) {
  const [error, setError] = reactExports.useState({
    isError: false,
    errorMessage: ""
  });
  const handleErrorTrue = reactExports.useCallback((message) => {
    setError({ isError: true, errorMessage: message });
  }, []);
  const handleErrorFalse = reactExports.useCallback(() => {
...
function useShopErrorContext() {
  const context = reactExports.useContext(ShopErrorContext);
  if (!context) {
...
function ErrorToastMessage() {
  const [toast, setToast] = reactExports.useState(true);
  ...
  return toast && /* @__PURE__ */ jsxRuntimeExports.jsx(Container$6, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorText, { children: errorMessage }) });
}
const Container$6 = newStyled(Flex)`
  height: 40px;
  position: absolute;
  top: 0;
...
`;
function Loading() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$5, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingImg, { src: "./assets/gifs/Loading.gif", alt: "로딩 스피너" }) });
}
...
async function postCartItem(id2) {
  return baseAPI({
    method: "POST",
    path: `/cart-items`,
    body: {
...
function CartProvider({ children }) {
  ...
  const getShoppingCartDataHandler = reactExports.useCallback(async () => {
    try {
...
function AddCartButton({ ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$4, { ...props, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonIcon$1, { src: "./assets/icons/AddCart.svg" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonText$1, { children: "담기" })
  ] });
}
const Container$4 = newStyled.button`
  ...
  padding: 4px 8px;
`;
const ButtonText$1 = newStyled.p`
  color: white;
  font-size: 14px;
  font-weight: 600;
`;
const ButtonIcon$1 = newStyled.img`
  width: 16px;
  height: 16px;
`;
function DeleteCartButton({ ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$3, { ...props, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonIcon, { src: "./assets/icons/DeleteCart.svg" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonText, { children: "빼기" })
  ] });
}
...
function ProductCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$2, { "data-testid": id2, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PreviewBox, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PreviewImage, { src: imageUrl }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(InfoBox, { children: [
      ...
      isInCart ? /* @__PURE__ */ jsxRuntimeExports.jsx(DeleteCartButton, { onClick: handleDeleteCart }) : /* @__PURE__ */ jsxRuntimeExports.jsx(AddCartButton, { onClick: handleAddCart })
    ] })
  ] });
}
...
function ProductList({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$1, { id: "product-list", "data-testid": "product-list", children: products.map(({ id: id2, name, price, imageUrl }) => {
    const matchingCart = cartList.find((cart) => cart.product.id === id2);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProductCard,
      {
        id: id2,
        cartId: (matchingCart == null ? void 0 : matchingCart.id) ?? null,
        name,
        price,
        imageUrl,
...
const Container$1 = newStyled.div`
  ...
  column-gap: 20px;
`;
async function getListData(filterOption) {
  const page = 0;
  const size = 20;
  const categoryPath = filterOption.category.value !== "전체" ? `category=${filterOption.category.value}&` : "";
...
const Container = newStyled.button`
  position: relative;
  width: 44px;
  height: 44px;
`;
...
const ItemsCountText = newStyled.p`
  ...
  font-weight: 700;
`;
function ShopHeader({ itemsCount }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { title: "SHOP", right: /* @__PURE__ */ jsxRuntimeExports.jsx(CartButton, { itemsCount }) });
}
function ShopPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ShopHeader, { itemsCount: cartList.length }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ProductListContainer, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(Loading, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ProductList,
        {
          resource: wrapPromise(getListDataHandler()),
          cartList
        }
      ) }),
      isError && /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorToastMessage, {})
    ] })
  ] });
}
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MobileLayout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShopErrorProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CartProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShopPage, {}) }) }) })
  ] });
}
